                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="card-box">
                            ...
                            <?php foreach ($lap as $lapangan){ ?>

                                <tr>

                                    <td><br><?php echo anchor('Maps/detail_lap/'.$lapangan->id_lap,$lapangan->nama_lap); ?></td>
                    ...
                    <div class="col-md-9">
                        <div class="card-box">
                            ...
                            <?php foreach ($lap_futsal as $u){ ?>
                                ...
                                <tr>
                                    <img width="250px" src="<?php echo base_url(); ?>assets/images/lapangan/<?php echo $u->foto; ?>"><br/>
                                    <td>Nama lapangan   :<?php echo$u->nama_lap; ?></td></br>
                                    <td>Alamat lapangan :<?php echo$u->alamat; ?></td></br>
                                    <td>No Telp.        :<?php echo$u->no_telp; ?></td></br>
                                    <td>Jenis Lapangam  :<?php echo$u->jenis_lap; ?></td></br>
